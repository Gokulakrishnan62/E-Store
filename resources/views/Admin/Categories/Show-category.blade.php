...
@section('body-content')
    <div class="store-edit-categories flex items-center justify-center bg-gradient-to-r from-gray-100 to-indigo-100 p-10">
        <div class="bg-white w-full max-w-5xl p-10 rounded-lg shadow-2xl">
            ...
            <form action="{{ route('update-category', $category->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                @csrf
